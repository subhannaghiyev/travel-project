...
import DropDownMenu from "../../pages/client/DropDownMenu";
...
const Header = () => {
  const items = [
    {
      label: (
        <Link style={{fontSize : 16 , fontFamily : "chillax-regular"}} to="/admin/loginAdmin">
         Admin Login
       </Link>
      ),
      key: "0",
    ...
    {
      label: (
       <Link style={{fontSize : 16 , fontFamily : "chillax-regular"}}  to="/login">
       Login
       </Link>
      ),
      key: "1",
  ...
  if (user && user.isAdmin === true) {
    ...
    localStorage.setItem("adminAge", user.age);
      ...
      <div className="head">
        <nav className="header">
          ...
          <ul className="list">
            ...
            <Link to="/about">
              <li style={{ fontSize: "16px" }}>About</li>
            </Link>
            <Link to="/offers">
            ...
            {user && (
              <Link to="/bought">
                <li style={{ fontSize: "16px" }}>Bought</li>
              </Link>
            )}
            {user && user.isAdmin === false ? (
              ...
              <Link to="/Login">
              <li style={{ fontSize: "16px" }}>Login</li>
            </Link>
